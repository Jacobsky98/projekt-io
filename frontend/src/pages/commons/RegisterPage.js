        ...
        <Grid container justify="center" alignItems="center">
            ...
            <Grid container justify="center">
                <FormControl>
                    ...
                    <Input onChange={(evt) => setName(evt.target.value)} className={classes.input} id="name"/>
                </FormControl>
            </Grid>
            <Grid container justify="center">
                <FormControl>
                    <InputLabel htmlFor="surname">Nazwisko</InputLabel>
                    <Input onChange={(evt) => setSurname(evt.target.value)} className={classes.input} id="surname"/>
                </FormControl>
            </Grid>
            <Grid container justify="center">
                <FormControl>
            ...
            <Grid container justify="center">
                <FormControl>
                    ...
                    <Input type="password" onChange={(evt) => setConfirmedPassword(evt.target.value)} className={classes.input} id="confirmedPassword"/>
                </FormControl>
            </Grid>
            <Grid container justify="center">
                <Button onClick={handleRegister} className={classes.button} variant="contained" size="large" color="primary">Zarejestruj</Button>
            </Grid>
            <Grid container justify="center">
                <Link to="/" className={classes.link}>Przejdź do logowania</Link>
            </Grid>
        </Grid>
    );
};
