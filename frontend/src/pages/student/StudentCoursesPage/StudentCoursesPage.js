...
const notices = [
    {date: '11-05-2020', content: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`},
    {date: '10-05-2020', content: `It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. `},
    {date: '09-05-2020', content: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`},
    {date: '08-05-2020', content: `It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. `},
    {date: '07-05-2020', content: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`},
    {date: '06-05-2020', content: `It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. `},
]
            ...
            <Grid item xs={3}>
                ...
                <Paper className="scrollable-list">
                    <List>
                        ...
                        <ListItem button>
                            <ListItemIcon><MenuBookIcon style={{color: '#4267B2'}}/></ListItemIcon>
                            <ListItemText primary={subject.name} secondary={`Prowadzący: ${subject.tutor}`} />
                        </ListItem>
                        )
                    }
                    </List>
                                            ...
                                            tasks.map((task) =>
                                                <ListItem button>
                                                    <Grid container direction="column">
                                                        ...
                                                        <Grid item>STATUS: {task.isSent ? 'WYSŁANE' : 'NIE WYSŁANO'}</Grid>
                                                    </Grid>
                                                </ListItem>
                                            )
                                        }
                                                ...
                                                {sentFiles &&
                                                    sentFiles.map((file) =>
                                                        <div className="added-file">
                                                            <div>{file.name}</div>
                                                            <div><IconButton style={{padding: 0}}><CloseIcon className="remove-file-icon"/></IconButton></div>
                                                        </div>)
                                                }

                                            </div>
                                        </Grid>
                                        <Grid container xs={4} direction="column" justify="space-around" alignItems="center">
                                                <Grid item>
                                                    <Button
                                                ...
                                                <Grid item><Button variant="contained" color="primary">Wyślij</Button></Grid>
                                        </Grid>
                                    </Grid>
                                </div>
                            </Grid>
